...
app.get('/contact-us',(req,res,next)=>{
  console.log("handling /contact-us with GET",req.url,req.method,req.bodyParser);
  res.send(`
...
app.post('/contact-us',(req,res,next)=>{
  console.log("handling /contact-us with POST first middleware",req.url,req.method,req.body);
  next();
})

//add bodyparser to parse the post 
app.use(bodyParser.urlencoded());

app.post('/contact-us',(req,res,next)=>{
  console.log("handling /contact-us with POST",req.url,req.method,req.body);
  res.send(`
